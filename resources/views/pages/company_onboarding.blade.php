                         ...
                         <form id="form-wizard1" class="text-center mt-4">
                             ...
                             <fieldset>
                                 <div class="form-card text-left">
                                     ...
                                     <div class="row">
                                       <div class="col-md-6">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group"> 
                                              <label for="ccnname">Company Contact Name</label> 
                                              <input type="text" class="form-control" name="ccn" placeholder="" />
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group"> 
                                              <label for="pno">Company Phone No</label> 
                                              <input type="number" class="form-control" name="pno" placeholder="" />
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group"> 
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="url" value="" placeholder="">
                                             </div>
                                          </div>
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                <label for="caddress">Company Physical Address</label>
                                                <textarea class="form-control" id="caddress" rows="2"></textarea>
                                             </div>
                                          </div>
                                    </div>
                                 </div> 
                                 <div class="form-card text-left">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="acname" placeholder="" />
                                           </div>
                                         </div>
                                         <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="curl">Company Website</label>
                                             <input type="url" class="form-control" id="curl" value="" placeholder="">
                                          </div>
                                          </div>
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                <label for="caaddress">Company Physical Address</label>
                                                <textarea class="form-control" id="caaddress" rows="2"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                    </div> 
                                    <div class="form-card text-left">
                                       ...
                                       <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="laname">Lead Assessor Name</label> 
                                                <input type="text" class="form-control" name="laname" placeholder="" />
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group"> 
                                                <label for="cred">Assessor PCI Credentials</label> 
                                                <input type="text" class="form-control" name="cred" placeholder="" />
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group"> 
                                              <label for="apno">Assessor Phone No</label> 
                                              <input type="number" class="form-control" name="apno" placeholder="" />
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group"> 
                                              <label for="aemail">Assessor E-mail Address</label> 
                                              <input type="email" class="form-control" name="aemail" placeholder="" />
                                             </div>
                                          </div>
                                          </div>
                                       </div> 
                                       <div class="form-card text-left">
                                          ...
                                          <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="laname">QA Reviewer Name</label> 
                                                   <input type="text" class="form-control" name="laname" placeholder="" />
                                                </div>
                                             </div>
                                             <div class="col-md-6">
                                                <div class="form-group"> 
                                                 <label for="qapno">QA Reviewer Phone No</label> 
                                                 <input type="number" class="form-control" name="qapno" placeholder="" />
                                                </div>
                                             </div>
                                             <div class="col-md-12">
                                                <div class="form-group"> 
                                                 <label for="qaemail">QA Reviewer E-mail Address</label> 
                                                 <input type="email" class="form-control" name="qaemail" placeholder="" />
                                                </div>
                                             </div>
                                             </div>
                                          </div> 
                             ...
                             <fieldset>
                                 <div class="form-card text-left">
                                     ...
                                     <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <label for="rdate">Date of Report</label>
                                             <input type="date" class="form-control" id="rdate" value="2022-7-14">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="assdate">Timeframe of assessment (start date)</label>
                                             <input type="date" class="form-control" id="assdate" value="2022-7-14">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="ascdate">Timeframe of assessment (completion date)</label>
                                             <input type="date" class="form-control" id="ascdate" value="2022-7-24">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="idsdate">Identify date(s) spent onsite at the entity(start date)</label>
                                             <input type="date" class="form-control" id="idsdate" value="2022-7-14">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="idcdate">Identify date(s) spent onsite at the entity(completion date)</label>
                                             <input type="date" class="form-control" id="idcdate" value="2022-7-24">
                                          </div>
                                       </div>
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <label for="spententity">Describe the time spent onsite at the entity, time spent performing remote assessment activities and time spent on validation of remediation activities</label>
                                             <textarea class="form-control" id="spententity" rows="2"></textarea>
                                          </div>
                                       </div>
                                     </div>
                                 </div> 
                             ...
                             <fieldset>
                                 <div class="form-card text-left">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="version">Version Of The PCI Data Security Standard Used For The Assessment</label>
                                          <textarea class="form-control" id="version" rows="2"></textarea>
                                       </div>
                                    </div>
                                 </div> 
                                 <button type="button" name="next" class="btn btn-primary next action-button float-right" value="Next" >Next</button> 
                             ...
                             <fieldset>
                              <div class="form-card text-left">
                                  <div class="row" style="border-bottom: 1px solid #f2edff;background: #000;">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="servicesbyQSAC">Disclose all services offered to the assessed entity by the QSAC, including but not limited to whether the assessed entity uses any security-related devices or security-related applications that have been developed or manufactured by the QSA, or to which the QSA owns the rights or that the QSA has configured or manages</label>
                                          <textarea class="form-control" id="servicesbyQSAC" rows="2"></textarea>
                                       </div>
                                    </div>
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="efforts">Describe efforts made to ensure no conflict of interest resulted from the above mentioned services provided by the QSAC</label>
                                          <textarea class="form-control" id="efforts" rows="2"></textarea>
                                       </div>
                                    </div>
                                 </div> 
                                 <button type="button" name="next" class="btn btn-primary next action-button float-right" value="Next" >Next</button> 
