    ...
    <div class="row">
        ...
        <div _ngcontent-att-c159="" class="login-wrap" style="position: relative;top: 22%;padding: 25px;width:500px !important;background:white;">
            ...
            <div _ngcontent-att-c159="" class="loginBtn">
                <div class="p-3">
                    <h3 class="account-title">{{ __('Two Factor Challenge') }}</h3>
                    <div class="account-subtitle"><hr class="set-hrleft"><span>{{ __('Please enter your authenticate code to login.') }}</span><hr class="set-hrright"></div>
                </div>
                <div _ngcontent-att-c159="">
                    ...
                    <form method="POST" action="{{ route('two-factor.login') }}">
                        ...
                        <div class="row mb-3">
                            <input id="code" type="code" placeholder="Code" name="code" class="form-control mb-0 @error('code') is-invalid @enderror" required>
                            <br>
                            @error('code')
