        ...
        <div _ngcontent-att-c159="" class="login-wrap">
            ...
            <div _ngcontent-att-c159="" class="loginBtn" >
                <div class="p-3">
                    ...
                    <div class="account-subtitle"><hr class="set-hrleft"><span>{{ __('Enter your email get reset password link') }}</span><hr class="set-hrright"></div>
                </div>
                <div _ngcontent-att-c159="">
                    ...
                    <form action="{{ route('password.email') }}" method="POST">
                        @csrf
                        <input type="input" placeholder="Email" name="email" value="{{ old('email') }}" required value="{{ old('email') }}" autocomplete="email" autofocus class="form-control mb-0 @error('email') is-invalid @enderror">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        <br>
                        <button _ngcontent-att-c159="" class="button btn btn-outline-dark text-center mb-2 lbtn">{{ __('Send Password Reset Link') }}</button>
                    </form>
                </div>
            </div>
        </div>
